# -*- coding: utf-8 -*-
"""
Created on Tue Apr  4 00:45:22 2023
    ...
    if ret ==True:
        ...
        if num_frames < 30:
            ...
            if hand is not None:
                ...
                if num < 90:
                    cv2.putText(clone, 'HAND GESTURE RECOGNITION READY', (50, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 3)
                ...
                #    cv2.putText(clone, wor, (50, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 3)
                    ...
                    res = get_result(operator)
                    in_line = operator + " = " + str(res)
                    cv2.putText(clone, "The gesture displayed is ", (50, 350), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 3)
                ...
                for cnt in contours:
                    if cv2.contourArea(cnt) > 5000:
                        ...
                        if num > 210 and num < 271: #num > 660 and num < 721:
                            pred = get_prediction(thresholded)
                            operator = pred
                            if pred == "Clear":
                                num = 211
